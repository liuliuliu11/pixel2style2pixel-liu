...
class TrainOptions:
    ...
    def initialize(self):
        self.parser.add_argument('--exp_dir', default='/home/ant/pixel2style2pixel-master/path', type=str, help='Path to experiment output directory')
        # self.parser.add_argument('--dataset_type', default='celebs_super_resolution', type=str, help='Type of dataset/experiment to run')
        ...
        self.parser.add_argument('--encoder_type', default='BackboneEncoderUsingLastLayerIntoW', type=str, help='Which encoder to use')
        # self.parser.add_argument('--encoder_type', default='BackboneEncoderUsingLastLayerIntoWPlus', type=str, help='Which encoder to use')

        self.parser.add_argument('--fineSize', default=256, type=int, help='size of input image ')
        ...
        # added by yangliu for distributed
        ...
        # self.parser.add_argument('--klloss_lambda', default=0, type=float, help='KL loss multiplier factor')
        ...
        # self.parser.add_argument('--checkpoint_path', default='/home/ant/path/to/experiment/checkpoints/best_model.pt',type=str, help='Path to pSp model checkpoint')
        self.parser.add_argument('--checkpoint_path', default=None, type=str, help='Path to pSp model checkpoint')

        self.parser.add_argument('--max_steps', default=200000, type=int, help='Maximum number of training steps')

        self.parser.add_argument('--image_interval', default=100, type=int, help='Interval for logging train Limages during training')
        ...
        self.parser.add_argument('--resize_factors', type=str, default='1,2,4,8,16', help='For super-res, comma-separated resize factors to use for inference.')
        # self.parser.add_argument('--resize_factors', type=str, default='1,2,4,8,16,32', help='For super-res, comma-separated resize factors to use for inference.'
